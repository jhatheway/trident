...
func NewTriCtx() PfCtx {
	pctx := NewPfCtx(NewTriUser, NewTriGroup, nil, nil, nil)
	tctx := &TriCtx{pfctx: pctx}
	pctx.SetAppData(tctx)
	return pctx
}

func TriGetCtx(ctx PfCtx) (tctx *TriCtx) {
...
func (tctx *TriCtx) SelectVouchee(username string, perms Perm) (err error) {
